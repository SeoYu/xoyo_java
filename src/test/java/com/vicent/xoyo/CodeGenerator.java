...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://xuyutech.top:3306/xoyo?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setModuleName("xoyo");
        pc.setParent("com.vicent");
...
//        strategy.setSuperEntityClass("你自己的父类实体,没有就不用设置!");
        strategy.setEntityLombokModel(true); // lombok entity
